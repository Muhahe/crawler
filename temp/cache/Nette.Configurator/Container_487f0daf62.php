<?php
// source: C:\xampp\htdocs\crawler\app/config/config.neon 
// source: C:\xampp\htdocs\crawler\app/config/config.local.neon 

class Container_487f0daf62 extends Nette\DI\Container
{
	protected $meta = array(
		'types' => array(
			'Nette\Object' => array(
				array(
					...
					'28_App_Model_crawlerModel',
					'29_App_Model_searchModel',
					'application.1',
					'application.2',
					'application.3',
					'application.4',
			...
			'App\Model\crawlerModel' => array(1 => array('28_App_Model_crawlerModel')),
			'App\Model\searchModel' => array(1 => array('29_App_Model_searchModel')),
			...
			'App\Presenters\SearchPresenter' => array(array('application.4')),
		...
		'services' => array(
			...
			'28_App_Model_crawlerModel' => 'App\Model\crawlerModel',
			'29_App_Model_searchModel' => 'App\Model\searchModel',
			...
			'application.4' => 'App\Presenters\SearchPresenter',
	...
	public function __construct()
	{
		parent::__construct(array(
			'appDir' => 'C:\xampp\htdocs\crawler\app',
			'wwwDir' => 'C:\xampp\htdocs\crawler\www',
			'debugMode' => TRUE,
			'productionMode' => FALSE,
			'environment' => 'development',
			'consoleMode' => FALSE,
			'container' => array('class' => NULL, 'parent' => NULL),
			'tempDir' => 'C:\xampp\htdocs\crawler\app/../temp',
		));
	}
	...
	/**
	 * @return App\Model\crawlerModel
	 */
	public function createService__28_App_Model_crawlerModel()
	{
		$service = new App\Model\crawlerModel($this->getService('database.default.context'));
		return $service;
	}


	/**
	 * @return App\Model\searchModel
	 */
	public function createService__29_App_Model_searchModel()
	{
		$service = new App\Model\searchModel($this->getService('database.default.context'), $this->getService('cache.storage'));
		return $service;
	}
	...
	{
		$service = new App\Presenters\HomepagePresenter($this->getService('database.default.context'), $this->getService('28_App_Model_crawlerModel'));
		$service->injectPrimary($this, $this->getService('application.presenterFactory'), $this->getService('routing.router'),
			$this->getService('http.request'), $this->getService('http.response'), $this->getService('session.session'),
			$this->getService('security.user'), $this->getService('latte.templateFactory'));
		$service->invalidLinkMode = 5;
	...
	{
		$service = new App\Presenters\SearchPresenter($this->getService('database.default.context'), $this->getService('29_App_Model_searchModel'));
		$service->injectPrimary($this, $this->getService('application.presenterFactory'), $this->getService('routing.router'),
			$this->getService('http.request'), $this->getService('http.response'), $this->getService('session.session'),
			$this->getService('security.user'), $this->getService('latte.templateFactory'));
		$service->invalidLinkMode = 5;
	...
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback($this, 5, 'C:\xampp\htdocs\crawler\app/../temp/cache/Nette%5CBridges%5CApplicationDI%5CApplicationExtension'));
	...
	{
		$service = new Nette\Caching\Storages\FileJournal('C:\xampp\htdocs\crawler\app/../temp');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('C:\xampp\htdocs\crawler\app/../temp/cache', $this->getService('cache.journal'));
		return $service;
	}
	...
	{
		$service = new Nette\Database\Connection('mysql:host=127.0.0.1;dbname=crawler;charset=utf8mb4', 'root', 'password',
			array('lazy' => TRUE));
	...
	{
		return new Container_487f0daf62_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory($this);
	}
	...
	public function createServiceNette__latte()
	{
		...
		trigger_error('Service nette.latte is deprecated, implement Nette\Bridges\ApplicationLatte\ILatteFactory.',
			16384);
		$service->setTempDirectory('C:\xampp\htdocs\crawler\app/../temp/cache/latte');
...
final class Container_487f0daf62_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory implements Nette\Bridges\ApplicationLatte\ILatteFactory
{
	private $container;


	public function __construct(Container_487f0daf62 $container)
	{
